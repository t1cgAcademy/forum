...
// takes an array of words and shortens it based on the 
// number of characters. This is does the same thing but 
// uses recursion.
...
// takes props from App.js and displays them
const History = props => {
  return (
          ...
          {props.history.map((post, i) => {
            return (
              <li className={handleHighlight(props.index, i)} key={i}>
                <div onClick={() => props.handleHistoryClick(i)}>
